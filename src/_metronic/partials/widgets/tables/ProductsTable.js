          ...
          <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
            ...
            <thead>
              <tr className='fw-bold text-muted'>
                ...
                <th className='min-w-140px'>Product Image</th>
                <th className='min-w-120px'>Organisation</th>
                <th className='min-w-120px'>Test for</th>
                <th className='min-w-120px'>SKU</th>
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>
                    <p className='text-dark fw-bold fs-6'>{item.image}</p>
                  </td>
                  <td>
                    <p className='text-dark fw-bold fs-6'>{item.organization}</p>
                  </td>
                  <td>
                    <p className='text-dark fw-bold fs-6'>{item.test_for}</p>
                  </td>
                  <td>
